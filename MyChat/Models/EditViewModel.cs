...
public class EditViewModel
{
    ...
    [Remote(action: "EditCheckEmail", controller:"Validation", AdditionalFields = "Id", ErrorMessage = "Этот Email уже занят, попробуйте еще раз!")]
    ...
    [Remote(action: "EditCheckUsername", controller:"Validation", AdditionalFields = "Id", ErrorMessage = "Этот UserName уже занят, попробуйте еще раз!")]
